 ...
 * @class.name QViewBase
 */
abstract class QViewBase_frame_ extends QModel 
{
	...
	{
		if ((($class === null) || ($class === get_called_class())) && ($new_way_reses = static::_get_Tpl_Compiled_Res()))
			return static::IncludeResourcesForClass_new($new_way_reses);
