 ...
 */
class QModel implements QIModel, Iterator 
{
	use QModel_Security, QModel_Trait, QModel_Common_View;
	 ...
	 */
	protected static $_Types_Cache = array();
	/**
	...
	protected static $_Type_Properties;
	...
	public $_typeIdsPath = [];
	public $_tmpid;
	# protected $_iter; # just to know about it
