...
QExtendClass("QDevModeSelectModelCtrl", "QWebControl", 
{
	/**
	...
	{
		var input = jQuery(".QDevModeSelectModelCtrl .classesSearch");
		...
		jQuery(".QDevModeSelectModelCtrl input.classesSearch").focus(function ()
		{
			jQuery(this).closest(".QDevModeSelectModelCtrl").find("ul.classesList").css("display", "block");
		});
		
		jQuery(".QDevModeSelectModelCtrl ul.classesList li a").click(function ()
		{
			var class_name = jQuery(this).closest("li").data("oclassname");
			var ctrl = jQuery(this).closest('.QDevModeSelectModelCtrl');
