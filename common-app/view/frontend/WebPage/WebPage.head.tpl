<head q-args="$branding = null">
    ...
    <script type="text/javascript" src="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'flexissframe/js/mvvm2.js')) ?>"></script>
    <script type="text/javascript" src="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'flexissframe/js/basic-controls.js')) ?>"></script>
	...
	<script type="text/javascript" src="<?= \QApp::GetWebPath(realpath(Q_VIEW_IMG_RESPONSIVE . 'img.responsive.js')) ?>"></script>
    ...
    <link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/js/trumbowyg/css/trumbowyg.min.css')) ?>" rel="stylesheet" />		
    <link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/js/tyippy/css/tippy.css')) ?>" rel="stylesheet" />
    <link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/js/splide/css/splide.core.min.css')) ?>" rel="stylesheet" />		
    <link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/js/splide/css/splide-default.min.css')) ?>" rel="stylesheet" />		
    <link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/js/nouislider/nouislider.all.min.css')) ?>" rel="stylesheet" />		
    <link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/js/fancybox/fancybox.min.css')) ?>" rel="stylesheet" />		
	<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.min.css" integrity="sha512-/zs32ZEJh+/EO2N1b0PEdoA10JkdC3zJ8L5FTiQu82LR9S/rOQNfQN7U59U9BC12swNeRAz3HSzIL2vpp4fv3w==" crossorigin="anonymous" /> -->
    <link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/css/custom.css')) ?>?i=<?= uniqid() ?>" rel="stylesheet" />
	<link href="<?= \QApp::GetWebPath(realpath(Q_VIEW_RES.'main/js/flatpickr/flatpickr.min.css')) ?>" rel="stylesheet" />
</head>