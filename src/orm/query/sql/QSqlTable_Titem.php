...
final class QSqlTable_Titem
{
	...
	protected function extractTypeIdFor_Class_Name(string $class_name)
	{
	...
	protected function get_mergeby_meta(string $class_name, string $parent_property_name, string $parent_class_name_or_zero, \QModelProperty $property = null)
	{
	...
	protected function get_mergeby_data(array $merge_by_meta, array &$merge_by_data, array &$merge_by_find, array &$merge_by_pool, array &$merge_by_linked, 
	...
	protected function extract_data_from_path(array $walk_struct, \QIModel $model)
	{
		$data = [];
		$valid = true;
		$key = "";
	...
	protected function process_merge_by(bool $on_app_search, array $mby_info, \QModelArray $array, string $app_prop, 
