 ...
 * @class.name Excel
 */
abstract class Excel extends \QModel
{
	/**
	 * @api.enable
	 * 
	 ...
	 * @param string $name
	 */
	public static function Download($template, $blocks = [], $path = null, $name = "Untitled.xlsm")
	{
		if (!$path)
		{
			$path = \QAutoload::GetTempWebPath();
			$path = ($path ? rtrim($path, "\\/")."/" : "").uniqid().".xlsm";
		}
	 ...
	 * @throws \Exception
	 */
	public static function GetTbsString($template, $blocks)
	{
